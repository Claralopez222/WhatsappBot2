const perguntasQuiz = [
  ...
  { p: '⚽ Qual jogador ganhou o chuteira de ouro na Copa de 2022?', r: 'mbappe', d: 'Futebol' },
  ...
  { p: '⚽ Qual jogador ganhou o MVP da final da Copa de 2022?', r: 'lionel messi', d: 'Futebol' },
  ...
  { p: '⚽ Qual goleiro defendeu o pênalti decisivo na Copa de 2006?', r: 'gigi buffon', d: 'Futebol' },
  { p: '⚽ Qual jogador foi eleito melhor do mundo pela FIFA em 2023?', r: 'erling haaland', d: 'Futebol' },
  { p: '⚽ Qual jogador foi revelado pelo Santos e hoje joga na Europa?', r: 'rodrygo', d: 'Futebol' },
  { p: '⚽ Quantos títulos da Champions League tem o Liverpool?', r: '6', d: 'Futebol' },
  { p: '⚽ Em que ano o Brasil foi eliminado nas oitavas da Copa de 2010?', r: '2010', d: 'Futebol' },
  { p: '⚽ Qual seleção venceu a Copa das Nações Africanas em 2024?', r: 'costa do marfim', d: 'Futebol' },
  { p: '⚽ Qual jogador tem o recorde de gols em Copas do Mundo para a Alemanha?', r: 'miroslav klose', d: 'Futebol' },
  ...
  { p: '🌊 Qual estreito separa a América do Norte da América do Sul?', r: 'panama', d: 'Geografia' },
  ...
  { p: '🏀 Qual país organizou os Jogos Olímpicos de 2024 onde o basquete foi disputado?', r: 'franca', d: 'Basquete' },
 ...
 *           !pontos, !rankjogos
 * - 185+ questões
 * - Cooldown de 1 hora por usuário (não por dia)
...
const quizCooldown   = new Map(); // senderJid → timestamp do último quiz iniciado
...
function tempoRestante(senderJid) {
  const ultimo = quizCooldown.get(senderJid);
  if (!ultimo) return 0;
  return Math.max(0, COOLDOWN_MS - (Date.now() - ultimo));
}
